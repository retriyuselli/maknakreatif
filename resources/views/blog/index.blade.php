...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-8">
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('blog') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                    Semua Artikel
                </a>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                        <div class="relative">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-medium">{{ $featured->category }}</span>
                            </div>
                        </div>
                        <div class="p-6 md:p-8">
                            ...
                            <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-4 hover:text-blue-600 transition-colors">
                                <a href="{{ route('blog.detail', $featured->slug) }}" class="block">{{ $featured->title }}</a>
                            </h2>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('blog.detail', $featured->slug) }}" class="text-blue-600 hover:text-blue-700 font-medium inline-flex items-center">
                                    Baca Selengkapnya
            ...
            <div class="lg:col-span-1 mt-12 lg:mt-0">
                <div class="sticky top-24 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        ...
                        <div class="space-y-3">
                            @foreach($categories as $category)
                            <a href="{{ route('blog.category', strtolower($category)) }}" class="flex items-center justify-between text-gray-700 hover:text-blue-600 transition-colors">
                                <span>{{ $category }}</span>
                            ...
                            <article class="flex space-x-3">
                                ...
                                <div>
                                    <h4 class="text-sm font-medium text-gray-900 hover:text-blue-600 transition-colors">
                                        <a href="{{ route('blog.detail', $popularPost->slug) }}" class="block">{{ Str::limit($popularPost->title, 50) }}</a>
                                    </h4>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @php
                            $popularTags = ['wedding', 'finance', 'business', 'tutorial', 'tips', 'budget', 'vendor', 'keuangan'];
                            @endphp
