...
<body class="bg-white text-gray-800">
    ...
    <footer class="gradient-bg text-white py-12">
        <div class="container mx-auto px-6">
            <div class="text-center">
                <h3 class="text-2xl font-bold mb-4">Makna Wedding Organizer</h3>
                <p class="text-gray-300 mb-6">Tim profesional yang siap mewujudkan pernikahan impian Anda</p>
                ...
                <div class="mt-8 pt-8 border-t border-gray-700">
                    <p class="text-gray-400">&copy; 2024 Makna Wedding Organizer. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
