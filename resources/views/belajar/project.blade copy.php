                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900">2.4B</p>
                        </div>
    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">Wedding Organizer</h3>
                    <p class="text-gray-400 mb-4">Portal internal untuk mengelola semua project wedding dengan efisien
                        dan profesional.</p>
                    <div class="flex space-x-4">
                        ...
                        <i class="fab fa-twitter text-blue-400 text-xl cursor-pointer hover:text-blue-300"></i>
                    </div>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="#" class="hover:text-white transition-colors">Vendors</a></li>
                ...
                <div>
                    ...
                    <div class="space-y-2 text-gray-400">
                        ...
                        <p><i class="fas fa-envelope mr-2"></i>info@weddingorganizer.com</p>
                        <p><i class="fas fa-map-marker-alt mr-2"></i>Jakarta, Indonesia</p>
                    </div>
                </div>
            </div>
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2024 Wedding Organizer Portal. All rights reserved.</p>
            </div>
        </div>
    </footer>
