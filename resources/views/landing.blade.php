...
<head>
    ...
    <title>PT. Makna Kreatif Indonesia</title>
    <!-- Favicon -->
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Haii haii kak ...!</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Selamat datang di portal keuangan PT. Makna Kreatif
                    Indonesia. Akses informasi dan data keuangan perusahaan secara terpusat di sini. <br>Silakan masuk
                    untuk melihat laporan, mengelola data, dan menggunakan fitur lainnya.</p>
            ...
            <div
                class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-square lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">

                <img src="{{ asset('images/team_makna.jpg') }}" alt="Person holding a DSLR camera"
                    class="w-full h-full object-cover transition-all translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-6">
            </div>
        </main>
    </div>
