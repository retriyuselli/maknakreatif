...
<body class="fi-page">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">
                        Rekonsiliasi Perbandingan - {{ $record->paymentMethod->bank_name }} {{ $record->paymentMethod->no_rekening }}
                    </h1>
                ...
                <div class="flex space-x-3">
                    <a href="{{ url('/admin/bank-statements/' . $record->id) }}" 
                       class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm font-medium">
                        ← Kembali
                    </a>
                    <a href="{{ url('/admin/reconciliation/export?' . http_build_query([
                    ...
                    <button onclick="autoMatchHighConfidence()" 
            ...
            <div class="bg-white shadow rounded-lg border border-gray-200">
                <div class="px-6 py-4 bg-blue-50 border-b border-gray-200">
                    <div class="flex items-center space-x-2">
                        ...
                        <h4 class="text-lg font-semibold text-blue-800">Data Bank Statement ({{ $record->reconciliationItems->count() }})</h4>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                @foreach($record->reconciliationItems->sortBy('date') as $item)
                                    @php
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-right text-gray-900 font-medium">
                                            <span class="{{ $runningBalance >= 0 ? 'text-green-600' : 'text-red-600' }}">
    ...
    function findManualMatch(sourceId, sourceTable) {
        alert('Fitur manual match untuk transaksi aplikasi akan segera tersedia.');
        // Implementation for manual matching app transactions
        console.log('Manual match for app transaction:', sourceId, sourceTable);
    }

    function findManualMatchBank(bankItemId) {
        alert('Fitur manual match untuk mutasi bank akan segera tersedia.');
        // Implementation for manual matching bank items
        console.log('Manual match for bank item:', bankItemId);
    }
    </script>
</body>
</html>