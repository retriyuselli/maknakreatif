    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('persentase_pembayaran')
                    ->label('% Dibayar')
                    ...
                    ->color(function ($record) {
                        if ($record->total_nilai <= 0) return 'gray';
                ...
                Tables\Columns\TextColumn::make('jatuh_tempo_terdekat')
                    ->label('Jatuh Tempo Terdekat')
                    ->date('d M Y')
                    ->color(function ($record) {
                        if (!$record->jatuh_tempo_terdekat) return 'gray';
