...
use Illuminate\Support\Facades\DB; // Pastikan ini diimpor jika menggunakan query kompleks

class AccountManagerStats extends BaseWidget
{
    protected static ?string $pollingInterval = null; // Nonaktifkan polling jika tidak perlu update real-time
