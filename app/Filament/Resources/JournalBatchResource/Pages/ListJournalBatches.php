...
use App\Filament\Resources\JournalBatchResource\Widgets\JournalSystemStatusWidget;
        ...
        return [
            ...
            Actions\Action::make('preview_pdf')
                ...
                ->form([
                    ...
                    \Filament\Forms\Components\Select::make('reference_type')
            ...
            Actions\ActionGroup::make([
                Actions\Action::make('regenerate_missing')
                ...
                Actions\Action::make('fix_expense_dates')
